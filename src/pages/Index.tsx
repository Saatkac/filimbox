...
import { HomeSkeleton, ContentGridSkeleton } from "@/components/ContentSkeleton";
  ...
  return (
    <div className="min-h-dvh bg-cinema-dark">
      ...
      <main id="main-content">
        {featuredContent && (
          <section
            className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] mt-14 sm:mt-16"
            ...
            <div className="relative container mx-auto px-4 h-full flex items-end pb-8 sm:items-center sm:pb-0">
              <div className="max-w-2xl">
                <div className="flex items-center gap-2 text-gold mb-2 sm:mb-4">
                  ...
                  <span className="text-xs sm:text-sm font-semibold uppercase tracking-wider">Öne Çıkan</span>
                </div>
                ...
                <Button
                  size="default"
                  className="bg-gold hover:bg-gold-light text-black font-semibold w-full sm:w-auto touch-manipulation active:scale-95 transition-transform min-h-11"
                  onClick={() => navigate(`/movie/${featuredContent.id}`)}
                  aria-label={`${featuredContent.title} izle`}
                >
                  <Play className="w-4 h-4 sm:w-5 sm:h-5 mr-2" aria-hidden="true" />
                  Şimdi İzle
                </Button>
              </div>
            </div>
        ...
        <section
          className="container mx-auto px-3 sm:px-4 pb-16 pt-4 sm:pt-0"
          aria-label="Tüm içerikler"
        >
